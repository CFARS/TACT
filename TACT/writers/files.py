...
def write_all_resultstofile(
    ...
    for correction in baseResultsLists[
        ...
        if stabilityFlag:
            ...
            for i in range(0, len(TI_MBE_j_stability_alpha_Ane)):
                (
                    ...
                    TI_MBE_j_stability_alpha_Ane[i],
                    Result_df_mean_1mps,
                    Result_df_mean_05mps,
                    Result_df_std_1mps,
                    Result_df_std_05mps,
            ...
            for i in range(0, len(RepTI_MBE_j_stability_alpha_Ane)):
                (
                    ...
                    RepTI_MBE_j_stability_alpha_Ane[i],
                    Result_df_mean_1mps,
                    Result_df_mean_05mps,
                    Result_df_std_1mps,
                    Result_df_std_05mps,
            ...
            for i in range(0, len(TI_Diff_j_stability_alpha_Ane)):
                (
                    ...
                    TI_Diff_j_stability_alpha_Ane[i],
                    Result_df_mean_1mps,
                    Result_df_mean_05mps,
                    Result_df_std_1mps,
                    Result_df_std_05mps,
            ...
            for i in range(0, len(RepTI_Diff_j_stability_alpha_Ane)):
                (
                    ...
                    RepTI_Diff_j_stability_alpha_Ane[i],
                    Result_df_mean_1mps,
                    Result_df_mean_05mps,
                    Result_df_std_1mps,
                    Result_df_std_05mps,
        ...
        if RSD_alphaFlag:
            ...
            for i in range(0, len(TI_MBE_j_stability_alpha_RSD)):
                (
                    ...
                    TI_MBE_j_stability_alpha_RSD[i],
                    Result_df_mean_1mps,
                    Result_df_mean_05mps,
                    Result_df_std_1mps,
                    Result_df_std_05mps,
            ...
            for i in range(0, len(RepTI_MBE_j_stability_alpha_RSD)):
                (
                    ...
                    RepTI_MBE_j_stability_alpha_RSD[i],
                    Result_df_mean_1mps,
                    Result_df_mean_05mps,
                    Result_df_std_1mps,
                    Result_df_std_05mps,
            ...
            for i in range(0, len(TI_Diff_j_stability_alpha_RSD)):
                (
                    ...
                    TI_Diff_j_stability_alpha_RSD[i],
                    Result_df_mean_1mps,
                    Result_df_mean_05mps,
                    Result_df_std_1mps,
                    Result_df_std_05mps,
            ...
            for i in range(0, len(RepTI_Diff_j_stability_alpha_RSD)):
                (
                    ...
                    RepTI_Diff_j_stability_alpha_RSD[i],
                    Result_df_mean_1mps,
                    Result_df_mean_05mps,
                    Result_df_std_1mps,
                    Result_df_std_05mps,
        ...
        if cup_alphaFlag:
            for i in range(0, len(TIbyRefbin_stability_alpha_Ane)):
                (
                    ...
                    TIbyRefbin_stability_alpha_Ane[i],
                    Result_df_mean_1mps,
                    Result_df_mean_05mps,
                    Result_df_std_1mps,
                    Result_df_std_05mps,
        ...
        if RSD_alphaFlag:
            for i in range(0, len(TIbyRefbin_stability_alpha_RSD)):
                (
                    ...
                    TIbyRefbin_stability_alpha_RSD[i],
                    Result_df_mean_1mps,
                    Result_df_mean_05mps,
                    Result_df_std_1mps,
                    Result_df_std_05mps,
        ...
        if cup_alphaFlag:
            for i in range(0, len(TI_Diff_r_stability_alpha_Ane)):
                (
                    ...
                    TI_Diff_r_stability_alpha_Ane[i],
                    Result_df_mean_1mps,
                    Result_df_mean_05mps,
                    Result_df_std_1mps,
                    Result_df_std_05mps,
                ...
                (
                    ...
                    RepTI_Diff_r_stability_alpha_Ane[i],
                    Result_df_mean_1mps,
                    Result_df_mean_05mps,
                    Result_df_std_1mps,
                    Result_df_std_05mps,
        ...
        if RSD_alphaFlag:
            for i in range(0, len(TI_Diff_r_stability_alpha_RSD)):
                (
                    ...
                    TI_Diff_r_stability_alpha_RSD[i],
                    Result_df_mean_1mps,
                    Result_df_mean_05mps,
                    Result_df_std_1mps,
                    Result_df_std_05mps,
                ...
                (
                    ...
                    RepTI_Diff_r_stability_alpha_RSD[i],
                    Result_df_mean_1mps,
                    Result_df_mean_05mps,
                    Result_df_std_1mps,
                    Result_df_std_05mps,
        ...
        # total stats
        if (
            isinstance(total_stats, pd.DataFrame)
            and isinstance(total_stats, tuple) == False
        ):
        ...
        if stabilityFlag:
            for i in range(0, len(total_stats_stability)):
                if (
                    isinstance(total_stats_stability[i], pd.DataFrame)
                    and isinstance(total_stats_stability[i], tuple) == False
                ):
                    ws.cell(
                        row=rowNumber,
                        column=1,
                        value=str("Total stats by stability_" + "Class_1"),
                    )
                    rowNumber += 1
        ...
        if cup_alphaFlag:
            for i in range(0, len(total_stats_stability_alpha_Ane)):
                if (
                    isinstance(total_stats_stability_alpha_Ane[i], pd.DataFrame)
                    and isinstance(total_stats_stability_alpha_Ane[i], tuple) == False
                ):
                    ws.cell(
                        row=rowNumber,
                        column=1,
                        value=str("Total stats by stability_alpha_Ane_" + "Class_1"),
                    )
                    rowNumber += 1
                    write_resultstofile(
                        total_stats_stability_alpha_Ane[i], ws, rowNumber, 1
                    )
        ...
        if RSD_alphaFlag:
            for i in range(0, len(total_stats_stability_alpha_RSD)):
                if (
                    isinstance(total_stats_stability_alpha_RSD[i], pd.DataFrame)
                    and isinstance(total_stats_stability_alpha_RSD[i], tuple) == False
                ):
                    ws.cell(
                        row=rowNumber,
                        column=1,
                        value=str("Total stats by stability_alpha_RSD_" + "Class_1"),
                    )
                    rowNumber += 1
                    write_resultstofile(
                        total_stats_stability_alpha_RSD[i], ws, rowNumber, 1
                    )
        ...
        if (
            isinstance(belownominal_stats, pd.DataFrame)
            and isinstance(belownominal_stats, tuple) == False
        ):
        ...
        if stabilityFlag:
            for i in range(0, len(belownominal_stats_stability)):
                if (
                    isinstance(belownominal_stats_stability[i], pd.DataFrame)
                    and isinstance(belownominal_stats_stability[i], tuple) == False
                ):
                    ws.cell(
                        row=rowNumber,
                        column=1,
                        value=str(
                            "belownominal stats by stability_" + "Class_" + str(i + 1)
                        ),
                    )
                    rowNumber += 1
                    write_resultstofile(
                        belownominal_stats_stability[i], ws, rowNumber, 1
                    )
        ...
        if cup_alphaFlag:
            for i in range(0, len(belownominal_stats_stability_alpha_Ane)):
                if (
                    isinstance(belownominal_stats_stability_alpha_Ane[i], pd.DataFrame)
                    and isinstance(belownominal_stats_stability_alpha_Ane[i], tuple)
                    == False
                ):
                    ws.cell(
                        row=rowNumber,
                        column=1,
                        value=str(
                            "belownominal stats by stability_alpha_Ane_"
                            + "Class_"
                            + str(i + 1)
                        ),
                    )
                    rowNumber += 1
                    write_resultstofile(
                        belownominal_stats_stability_alpha_Ane[i], ws, rowNumber, 1
                    )
        ...
        if RSD_alphaFlag:
            for i in range(0, len(belownominal_stats_stability_alpha_RSD)):
                if (
                    isinstance(belownominal_stats_stability_alpha_RSD[i], pd.DataFrame)
                    and isinstance(belownominal_stats_stability_alpha_RSD[i], tuple)
                    == False
                ):
                    ws.cell(
                        row=rowNumber,
                        column=1,
                        value=str(
                            "belownominal stats by stability_alpha_RSD_"
                            + "Class_"
                            + str(i + 1)
                        ),
                    )
                    rowNumber += 1
                    write_resultstofile(
                        belownominal_stats_stability_alpha_RSD[i], ws, rowNumber, 1
                    )
        ...
        if (
            isinstance(abovenominal_stats, pd.DataFrame)
            and isinstance(abovenominal_stats, tuple) == False
        ):
        ...
        if stabilityFlag:
            for i in range(0, len(abovenominal_stats_stability)):
                if (
                    isinstance(abovenominal_stats_stability[i], pd.DataFrame)
                    and isinstance(abovenominal_stats_stability[i], tuple) == False
                ):
                    ws.cell(
                        row=rowNumber,
                        column=1,
                        value=str(
                            "abovenominal stats by stability_" + "Class_" + str(i + 1)
                        ),
                    )
                    rowNumber += 1
                    write_resultstofile(
                        abovenominal_stats_stability[i], ws, rowNumber, 1
                    )
        ...
        if cup_alphaFlag:
            for i in range(0, len(abovenominal_stats_stability_alpha_Ane)):
                if (
                    isinstance(abovenominal_stats_stability_alpha_Ane[i], pd.DataFrame)
                    and isinstance(abovenominal_stats_stability_alpha_Ane[i], tuple)
                    == False
                ):
                    ws.cell(
                        row=rowNumber,
                        column=1,
                        value=str(
                            "abovenominal stats by stability_alpha_Ane_"
                            + "Class_"
                            + str(i + 1)
                        ),
                    )
                    rowNumber += 1
                    write_resultstofile(
                        abovenominal_stats_stability_alpha_Ane[i], ws, rowNumber, 1
                    )
        ...
        if RSD_alphaFlag:
            for i in range(0, len(abovenominal_stats_stability_alpha_RSD)):
                if (
                    isinstance(abovenominal_stats_stability_alpha_RSD[i], pd.DataFrame)
                    and isinstance(abovenominal_stats_stability_alpha_RSD[i], tuple)
                    == False
                ):
                    ws.cell(
                        row=rowNumber,
                        column=1,
                        value=str(
                            "abovenominal stats by stability_alpha_RSD_"
                            + "Class_"
                            + str(i + 1)
                        ),
                    )
                    rowNumber += 1
                    write_resultstofile(
                        abovenominal_stats_stability_alpha_RSD[i], ws, rowNumber, 1
                    )
            ...
            for i in range(0, len(rep_TI_results_1mps_stability)):
                if isinstance(rep_TI_results_1mps_stability[i], pd.DataFrame):
                    ws.cell(
                        ...
                        column=1,
                        value=str(
                            "representative stats by stability_" + "Class_" + str(i + 1)
                        ),
                    )
                    rowNumber += 1
                    try:
                        write_resultstofile(
                            rep_TI_results_1mps_stability[i], ws, rowNumber, 1
                        )
            ...
            for i in range(0, len(rep_TI_results_1mps_stability_alpha_Ane)):
                if isinstance(rep_TI_results_1mps_stability_alpha_Ane[i], pd.DataFrame):
                    ws.cell(
                        ...
                        column=1,
                        value=str(
                            "representative stats by stability_alpha_Ane_"
                            + "Class_"
                            + str(i + 1)
                        ),
                    )
                    ...
                    try:
                        write_resultstofile(
                            rep_TI_results_1mps_stability_alpha_RSD[i], ws, rowNumber, 1
                        )
            ...
            for i in range(0, len(rep_TI_results_1mps_stability_alpha_RSD)):
                if isinstance(rep_TI_results_1mps_stability_alpha_RSD[i], pd.DataFrame):
                    ws.cell(
                        ...
                        column=1,
                        value=str(
                            "representative stats by stability_alpha_RSD_"
                            + "Class_"
                            + str(i + 1)
                        ),
                    )
        ...
        if stabilityFlag:
            for i in range(0, len(rep_TI_results_05mps_stability)):
                if isinstance(rep_TI_results_05mps_stability[i], pd.DataFrame):
                    ...
                    rowNumber += 1
                    write_resultstofile(
                        rep_TI_results_05mps_stability[i], ws, rowNumber, 1
                    )
        ...
        if cup_alphaFlag:
            for i in range(0, len(rep_TI_results_05mps_stability_alpha_Ane)):
                if isinstance(rep_TI_results_05mps_stability[i], pd.DataFrame):
                    ...
                    try:
                        write_resultstofile(
                            rep_TI_results_05mps_stability_alpha_Ane[i],
                            ws,
                            rowNumber,
                            1,
                        )
                        rowNumber += (
                            len(rep_TI_results_05mps_stability_alpha_Ane[i]) + 3
                        )
                    except:
                        ws.cell(row=rowNumber, column=1, value=np.NaN)
                        rowNumber += 4
        ...
        if RSD_alphaFlag:
            for i in range(0, len(rep_TI_results_05mps_stability_alpha_RSD)):
                if isinstance(
                    rep_TI_results_05mps_stability_alpha_RSD[i], pd.DataFrame
                ):
                    ws.cell(
                        row=rowNumber,
                        column=1,
                    ...
                    try:
                        write_resultstofile(
                            rep_TI_results_05mps_stability_alpha_RSD[i],
                            ws,
                            rowNumber,
                            1,
                        )
                        rowNumber += (
                            len(rep_TI_results_05mps_stability_alpha_RSD[i]) + 3
                        )
                    except:
                        ws.cell(row=rowNumber, column=1, value=np.NaN)
                        rowNumber += 4
