...
from TACT.computation.adjustments import Adjustments, get_all_regressions, train_test_split, quick_metrics
...
from TACT.computation.stability import calculate_stability_TKE, calculate_stability_alpha
from TACT.computation.TI import get_count_per_WSbin, get_TI_MBE_Diff_j, get_TI_Diff_r, get_representative_TI, get_TI_bybin, get_TI_byTIrefbin, get_description_stats, Dist_stats, get_representative_TI, record_TIadj
...
from TACT.writers.labels import initialize_resultsLists, populate_resultsLists, populate_resultsLists_stability
...
if __name__ == '__main__':
    ...
    stabilityClass_tke, stabilityMetric_tke, regimeBreakdown_tke = calculate_stability_TKE(inputdata, config)
    cup_alphaFlag, stabilityClass_ane, stabilityMetric_ane, regimeBreakdown_ane, Ht_1_ane, Ht_2_ane, stabilityClass_rsd, stabilityMetric_rsd, regimeBreakdown_rsd = calculate_stability_alpha(inputdata, config, config_file, RSD_alphaFlag, Ht_1_rsd, Ht_2_rsd)
    #------------------------
    ...
    if timetestFlag == True:
        ...
        for s in splitList[1:]:
            ...
            TimeTestA_baseline_df, time_test_A_adjustment_df = quick_metrics(inputdata_test, config, TimeTestA_baseline_df, time_test_A_adjustment_df, str(100-s))
        ...
        for i in range(0,numberofDaysInTest):
            ...
            TimeTestB_baseline_df, time_test_B_adjustment_df = quick_metrics(inputdata_test, config, TimeTestB_baseline_df, time_test_B_adjustment_df,str(numberofDaysInTest-i))
        ...
        if len(inputdata) > (numberofObsinOneDay*90): # check to see if experiment is greater than 3 months
            ...
            while windowEnd < len(inputdata):
                ...
                TimeTestC_baseline_df, time_test_C_adjustment_df = quick_metrics(inputdata_test, config, TimeTestC_baseline_df, time_test_C_adjustment_df,
